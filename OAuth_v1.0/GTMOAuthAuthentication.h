...
_EXTERN NSString* const kGTMOAuthTouchCancel _INITIALIZE_AS(@"kGTMOAuthTouchCancel");
_EXTERN NSString* const kGTMOAuthDialogDismissed _INITIALIZE_AS(@"kGTMOAuthDialogDismissed");
