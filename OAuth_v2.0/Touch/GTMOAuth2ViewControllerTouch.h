...
@interface GTMOAuth2ViewControllerTouch : BaseOAuthViewController <UINavigationControllerDelegate, UIWebViewDelegate> {
 @private
...
@property (strong, nonatomic) IBOutlet UINavigationItem *navigationBarItem;//Added by DAEMMON
