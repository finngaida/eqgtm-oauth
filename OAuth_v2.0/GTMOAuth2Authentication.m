...
NSString *const kGTMOAuth2TouchCancel           = @"kGTMOAuth2TouchCancel";
NSString *const kGTMOAuth2DialogDismissed       = @"kGTMOAuth2DialogDismissed";
...
- (GTMHTTPFetcher *)beginTokenFetchWithDelegate:(id)delegate
  ...
  if (grantTypeParams) {
    ...
    if(self.useRequestBody){
        ...
        NSString *fullURL = [NSString stringWithFormat:@"%@?%@",[tokenURL absoluteString],paramStr];
