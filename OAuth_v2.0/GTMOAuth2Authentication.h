...
extern NSString *const kGTMOAuth2TouchCancel;
extern NSString *const kGTMOAuth2DialogDismissed;
...
//Addede by daemmon
//Allow Use access token request URL parameters in request body
//LinkedIn may return no valid token if access token request URL parameters
@property (assign) BOOL useRequestBody;
